    ...
    public static class CommandLineConvert
    {
        ...
        internal static void ConvertOrReturn(string productIdentifier, string[] commandLineArguments)
        {
            if (commandLineArguments.Length > 1)
            {
                ...
                if (firstArgument == "/convert" || firstArgument == "-convert" || firstArgument == "/help" || firstArgument == "-help" || firstArgument == "/?" || firstArgument == "-?" )
                {
                    Environment.Exit(Convert(productIdentifier, commandLineArguments));
                }
            }
        }

        private static int Convert(string productIdentifier, string[] arguments) // E.g.: /convert *.txt SubRip
        {
            ...
            if (arguments.Length < 4)
            {
                if (arguments.Length == 3 &&
                    (arguments[2].Equals("/formats", StringComparison.OrdinalIgnoreCase) || arguments[2].Equals("-formats", StringComparison.OrdinalIgnoreCase) ||
                     arguments[2].Equals("/list", StringComparison.OrdinalIgnoreCase) || arguments[2].Equals("-list", StringComparison.OrdinalIgnoreCase))) // backward compatibility
                {
